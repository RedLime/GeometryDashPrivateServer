...
if(!empty($str)){ //AWARDED
	if ($str == "mainepic") {
		$params = array();
		$params[] = "NOT starMainEpic = 0";
		$order = "rateDate DESC,uploadDate";
	}
}
